...
var zipFile;
//zipFile = '../node_modules/nmredata-data-test/data/menthol_1D_1H_assigned_J.zip'; 
zipFile = '../data/mentTest/menthol_1D_1H_assigned_J.zip'; //  OK
zipFile = '../data/menthol/menthol_1D_1H_assigned_J.zip'; // not OK
var isOK = existsSync(resolve(zipFile), 'base64');

if (!isOK) {
  console.log("File not found : " + zipFile);
} else {
  console.log("File found : " + zipFile);

var zipData = readFileSync(resolve(zipFile), 'base64');
readNmrRecord(zipData, {
  ...
  console.log("nmredata.ASSIGNMENT headComment: " + JSON.stringify(nmredata.ASSIGNMENT.headComment, undefined, 2));
