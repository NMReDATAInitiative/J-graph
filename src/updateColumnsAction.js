export function updateColumnsAction(spreadPositions, timeAnimation, positionJscale, topJGraphYposition, colorShowLine, colorHideLine, generalUseWidth, x, width, jgraphObj, blockWidth, yJs) {
 console.log("jgraphObj.theColumns.theColumnsConnectColumnToSpectrumPosition", jgraphObj.theColumns.theColumnsConnectColumnToSpectrumPosition)
 console.log("jgraphObj.theColumns.theColumnsConnectColumnToSpectrumPosition", jgraphObj.theColumns.theColumnsConnectColumnToSpectrumPosition)
...
if (typeof colorShowLine === 'undefined') {
 ...
 console.log("found   theColumnsVerticalInSpectrum to adjust");
   jgraphObj.theColumns.theColumnsVerticalInSpectrum
             ...
             .attr("x2", function (d) { return x(d.chemShift); })
             .attr("stroke", function (d) {
               console.log(" d.chemShift ",d.chemShift," x(d.chemShift) ",x(d.chemShift)," width ",width);
    ...
    console.log("jgraphObj.theColumns.theColumnsMainVerticalBackLine",jgraphObj.theColumns.theColumnsMainVerticalBackLine)    
         ...
         if (true)   if ('theDots' in jgraphObj)
           jgraphObj.theDots
             .transition().duration(timeAnimation)
...
/*
           theTextDots2
            ...
            ;
*/
          if (true) if ('theBlocks' in jgraphObj)
           jgraphObj.theBlocks
             .transition().duration(timeAnimation)
  ...
  jgraphObj.theColumns.theColumnLabel
    ...
    .attr("transform", function (d) {
      ...
      if (isNaN(yPosition) || isNaN(spreadPositions[d.MyIndex])) {
        console.error('Invalid numeric values:', yPosition, spreadPositions[d.MyIndex]);
        console.error('Invalid numeric topJGraphYposition:', topJGraphYposition);
